...
```bash
# First page
curl "https://indexer.api.umbraprivacy.com/v1/utxos?start=0&limit=1000"

# Next page
curl "https://indexer.api.umbraprivacy.com/v1/utxos?start=1000&limit=1000"

# Fetch a specific range (e.g. all UTXOs in tree 1: absolute indices 1,048,576 to 2,097,151)
curl "https://indexer.api.umbraprivacy.com/v1/utxos?start=1048576&end=2097151&limit=5000"
```
