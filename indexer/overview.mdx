...
description: "UTXO indexer REST API at indexer.api.umbraprivacy.com. Protobuf responses, paginated UTXOs, Merkle proofs, batch proofs. Used by getClaimableUtxoScannerFunction."
---
...
- **Mainnet** - `https://indexer.api.umbraprivacy.com`

<Warning>
The devnet indexer is not yet available. All indexer API calls should target the mainnet endpoint above.
</Warning>
