...
description: "V14 mint list: wSOL, USDC, USDT, UMBRA, CASH on mainnet; wSOL only on devnet. Each pool supports both EncryptedTokenAccount operations and the Stealth Pool mixer, including Token-2022 transfer fees."
---
