---
title: "Query"
description: "API reference: getEncryptedBalanceQuerierFunction (Rescue cipher decryption for shared-mode) + getUserAccountQuerierFunction (EncryptedUserAccount fields)."
---
...
- `accountInfoProvider?: AccountInfoProviderFunction`
- `rescueCipherDecryptor?: RescueCipherDecryptorFunction` - Override the Rescue cipher decryptor used for shared-mode balance decryption.
