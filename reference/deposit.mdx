---
title: "Deposit"
description: "API reference: getPublicBalanceToEncryptedBalanceDirectDepositorFunction (DepositResult) + 4 UTXO creators for self/receiver-claimable from encrypted/public balance."
---
