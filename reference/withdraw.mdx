---
title: "Withdrawal"
description: "API reference: getEncryptedBalanceToPublicBalanceDirectWithdrawerFunction returns WithdrawResult with queueSignature and callbackSignature via Arcium MPC."
---
