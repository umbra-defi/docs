---
title: "SDK Reference"
description: "Complete SDK reference index: all factory functions and the subpath each lives under (registration, deposit, withdrawal, burn, query, conversion, compliance, account, zk-prover, store-adapters)."
---

This reference covers the full public API surface of `@umbra-privacy/sdk@5.x`. Pages are organised by feature area — each section documents factory functions alongside their parameter types, result types, and associated errors.
...
- `@umbra-privacy/sdk/shared` — `UMBRA_MESSAGE_TO_SIGN`, `BPS_DIVISOR`, and protocol-wide constants
...
- `@umbra-privacy/sdk/constants` — mint lists, domain separators, network configs
