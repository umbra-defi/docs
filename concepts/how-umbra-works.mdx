...
description: "How Umbra works: encrypted balances via Arcium MPC dual-instruction pattern (queue_computation + arcium_callback), UTXO mixer with Indexed Merkle Tree, and compliance grants."
---
