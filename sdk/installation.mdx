---
title: "Installation"
description: "Install @umbra-privacy/sdk. Sub-path imports: /types (branded primitives), /interfaces (function types), /utils (PDA helpers), /constants (network configs), /errors (error classes)."
---
