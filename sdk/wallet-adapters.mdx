...
description: "IUmbraSigner interface and adapters: createInMemorySigner (keypair), createSignerFromWalletAccount (Wallet Standard). Covers UMBRA_MESSAGE_TO_SIGN consent and signMessage requirements."
---
...
```bash
pnpm add @wallet-standard/app @wallet-standard/core @wallet-standard/features
```
