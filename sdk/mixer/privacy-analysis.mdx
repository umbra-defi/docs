...
description: "3-tier privacy model: EncryptedBalance-to-EncryptedBalance (strongest), mixed flows (partial), ATA-to-ATA (weakest). Covers timing analysis, amount correlation, and anonymity set sizing."
---
