...
description: "getBurnableStealthPoolNoteScannerFunction (V14, zero-arg): walks every active tree, decrypts X25519-AES ciphertexts addressable by your viewing keys, persists cursor in client.utxoDataStore. Returns ScannedStealthPoolNoteResult grouped by (kind, source)."
---
...
The V14 scanner is **zero-arg** — the cursor is fully SDK-managed.
...
const result = await scan(); // zero-arg in V14
```
...
// Burn all receiver-burnable notes from PATA-source writes into your ETA.
