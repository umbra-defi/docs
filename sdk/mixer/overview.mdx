...
- `getCreateSelfClaimableUtxoFromEncryptedBalanceFunction` - source: encrypted balance, unlocker: you
- `getCreateReceiverClaimableUtxoFromEncryptedBalanceFunction` - source: encrypted balance, unlocker: recipient
