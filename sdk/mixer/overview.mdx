...
description: "Mixer overview: 4 UTXO creation variants (encrypted/public x self/receiver), 3 claim variants (to encrypted, to public, to public direct). Self-claimable vs receiver-claimable flows."
---
