...
description: "4 UTXO creation functions: getEncryptedBalance[Self/Receiver]ClaimableUtxoCreatorFunction and getPublicBalance[Self/Receiver]ClaimableUtxoCreatorFunction. Merkle tree insertion and ciphertext publish."
---
