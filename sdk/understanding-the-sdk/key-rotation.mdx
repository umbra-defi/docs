...
description: "Offset-based key rotation: U512 offsets on getUmbraClient shift KMAC256 derivation to produce new X25519, MVK, and commitment keys for the same wallet. Complete deps map per V14 factory."
---
...
## Per-Factory Deps Reference (V14)
...
**`getATAIntoSelfBurnableStealthPoolNoteCreatorFunction`** (PATA-source, no MPC)
- `accountInfoProvider`, `blockhashProvider`, `transactionForwarder`.
- All MVK / Poseidon / ephemeral-note key derivers.
