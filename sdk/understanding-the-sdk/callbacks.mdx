...
description: "TransactionCallbacks interface: PreTransactionCallback and PostTransactionCallback hooks fired around sign/send/confirm lifecycle. Used for progress UI, analytics, and transaction logging."
---
