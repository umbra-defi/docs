...
description: "SDK architecture: factory pattern with get[Source]To[Target][Verb]Function naming, args (required params) vs deps (injectable providers), and per-call commitment overrides."
---
