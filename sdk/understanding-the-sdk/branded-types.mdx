---
title: "Branded Types"
description: "How the SDK uses nominal typing to prevent silent type confusion, and how to use the create* helper functions before passing values into SDK operations."
---
