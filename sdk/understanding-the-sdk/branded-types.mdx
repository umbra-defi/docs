...
const commitment: U256 = createU256(rawCommitmentBigint, "noteCommitment");
```
...
```typescript
import { createRcCiphertext } from "@umbra-privacy/sdk/types";
...
```typescript
import { createU64 } from "@umbra-privacy/sdk/types";
import { MathematicsAssertionError } from "@umbra-privacy/sdk/errors";
