...
description: "SDK type system (V14): branded types U64/U128/U256, Bn254FieldElement, X25519PublicKey. Integration with @solana/kit Address and TransactionSignature. Function types via the named subpath of each operation family."
---
...
Every returned function has a named type exported from the **same subpath** as its factory. There is no separate `@umbra-privacy/sdk/interfaces` re-export in V14 — types ship alongside their factories.
...
import type { FromPublicAssociatedTokenAccountIntoEncryptedTokenAccountDirectDepositorFunction } from "@umbra-privacy/sdk/deposit";
import { getATAIntoETADirectDepositorFunction } from "@umbra-privacy/sdk/deposit";

const [deposit, setDeposit] =
  useState<FromPublicAssociatedTokenAccountIntoEncryptedTokenAccountDirectDepositorFunction | null>(null);
