...
<ParamField path="userAddress" type="Address" required>
  The wallet address to query. This is the only argument — the querier takes no options object.
</ParamField>
...
<ResponseField name="isUserCommitmentRegistered" type="boolean">
  Poseidon user commitment registered; receiving receiver-burnable Stealth Pool Notes is enabled.
</ResponseField>
...
<ResponseField name="x25519PublicKey" type="Uint8Array">
  32-byte X25519 public key. Used by senders to encrypt Stealth Pool Notes addressed to this account.
</ResponseField>
...
<ParamField path="mints" type="readonly Address[]" required>
  Mint addresses to query. This is the only argument — the querier takes no options object.
</ParamField>
