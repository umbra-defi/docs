...
description: "Complete V14 reference for converting MXE-only ETAs to Shared mode + rotating the per-mint X25519 key."
---
...
function getMintEncryptionKeyRotatorFunction(
  args: { client: IUmbraClient },
  deps?: GetMintX25519KeyRotatorFunctionDeps,
): MintX25519KeyRotatorFunction;
```
