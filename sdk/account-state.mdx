---
title: "Account State"
description: "getUserAccountQuerierFunction: read EncryptedUserAccount fields (X25519 key, user commitment, generation index, registration steps) for any address without submitting transactions."
---
