---
title: "Deposit"
description: "getPublicBalanceToEncryptedBalanceDirectDepositorFunction: transfer SPL/Token-2022 tokens from public ATA to encrypted balance. Returns DepositResult with net amount and tx signatures."
---
