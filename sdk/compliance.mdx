---
title: "Compliance"
description: "Two independent compliance mechanisms: hierarchical viewing keys (MVK + Poseidon-derived temporal keys) for mixer UTXOs, and X25519 compliance grants for encrypted balance re-encryption."
---
