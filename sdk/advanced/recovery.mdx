---
title: "Recovery"
description: "Deterministic recovery: same wallet + same network recreates all keys. Re-scan via zero-arg getBurnableStealthPoolNoteScannerFunction. Master seed persistence patterns. Dropped MPC callback recovery via getStagedSpl/SolRecovererFunction."
---
