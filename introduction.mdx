...
- **Shield balances** — move tokens from a public Associated Token Account (PATA) into an **EncryptedTokenAccount (ETA)** where the balance is hidden from everyone except authorized viewers.
...
- **PATA** — `PublicAssociatedTokenAccount`. A standard SPL Associated Token Account holding plaintext tokens.
...
- **Devnet:** `342qFp62fzTt4zowrVPhrDdcRLGapPCMe8w5kFSoJ4f4`
