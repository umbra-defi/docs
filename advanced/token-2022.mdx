...
description: "Token-2022 transfer fee handling in V14: epoch-based fee schedule detection, fee deduction before protocol fees, epochInfoCommitment override. Affects PATA-source operations only."
---
...
Transfer fee handling applies to these PATA-source operations:
...
- `getETAIntoATAWithdrawerFunction` — same (the transfer back into a PATA also crosses the Token-2022 boundary).
